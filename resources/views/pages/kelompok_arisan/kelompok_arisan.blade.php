                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" placeholder="{{ __('Nama Kelomok') }}"
                                                        type="text" name="nama_kelompok" value="{{ old('nama_kelompok') }}" required
                                                        autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <select class="form-control" name="nama_arisan" id="nama_arisan">
                            ...
                            <table class="table align-items-center table-dark table-flush">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="alamat">Keterngan</th>
...
$('#nama_arisan').on('change',function(e) {
...
$('#keterangan').empty();
// $.each(data.arisan[0].arisan,function(index,hasil){
$('#keterangan').text("KONTOL");
// })
}
})
});
